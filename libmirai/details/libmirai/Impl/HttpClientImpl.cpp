...
// 	auto result = this->client_.Post("/verify", body.dump(), JSON_CONTENT_TYPE);
...
// 	auto result = this->client_.Post("/bind", body.dump(), JSON_CONTENT_TYPE);
// 	json resp = Utils::ParseResponse(result);
// 	return resp;
// }
...
json HttpClientImpl::SessionInfo(const string& SessionKey)
{
	...
	auto result = this->client_.Get("/sessionInfo", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
// 	auto result = this->client_.Get("/release", params, httplib::Headers{});
// 	json resp = Utils::ParseResponse(result);
// 	return resp;
// }
...
// {
// 	httplib::Params params = {{"sessionKey", SessionKey}};
// 	auto result = this->client_.Get("/countMessage", params, httplib::Headers{});
// 	json resp = Utils::ParseResponse(result);
// 	return resp.at("data");
// }
...
// 	auto result = this->client_.Get("/fetchMessage", params, httplib::Headers{});
// 	json resp = Utils::ParseResponse(result);
// 	return resp.at("data");
// }
...
// {
// 	httplib::Params params = {{"sessionKey", SessionKey}, {"count", std::to_string(count)}};
// 	auto result = this->client_.Get("/fetchLatestMessage", params, httplib::Headers{});
// 	json resp = Utils::ParseResponse(result);
// 	return resp.at("data");
// }
...
// {
// 	httplib::Params params = {{"sessionKey", SessionKey}, {"count", std::to_string(count)}};
// 	auto result = this->client_.Get("/peekMessage", params, httplib::Headers{});
// 	json resp = Utils::ParseResponse(result);
// 	return resp.at("data");
// }
...
// {
// 	httplib::Params params = {{"sessionKey", SessionKey}, {"count", std::to_string(count)}};
// 	auto result = this->client_.Get("/peekLatestMessage", params, httplib::Headers{});
// 	json resp = Utils::ParseResponse(result);
// 	return resp.at("data");
// }
...
{
	auto result = this->client_.Get("/about");
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
{
	auto result = this->client_.Get("/botList");
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
json HttpClientImpl::MessageFromId(const string& SessionKey, MessageId_t id, UID_t target)
{
	...
	auto result = this->client_.Get("/messageFromId", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
{
	httplib::Params params = {{"sessionKey", SessionKey}};
	auto result = this->client_.Get("/friendList", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
{
	httplib::Params params = {{"sessionKey", SessionKey}};
	auto result = this->client_.Get("/groupList", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
json HttpClientImpl::MemberList(const string& SessionKey, GID_t target)
{
	...
	auto result = this->client_.Get("/memberList", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
{
	httplib::Params params = {{"sessionKey", SessionKey}};
	auto result = this->client_.Get("/botProfile", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	httplib::Params params = {{"sessionKey", SessionKey}, {"target", target.to_string()}};
	auto result = this->client_.Get("/friendProfile", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::MemberProfile(const string& SessionKey, GID_t target, QQ_t MemberId)
{
	...
	auto result = this->client_.Get("/memberProfile", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	httplib::Params params = {{"sessionKey", SessionKey}, {"target", target.to_string()}};
	auto result = this->client_.Get("/userProfile", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                       ...
                                       std::optional<MessageId_t> QuoteId)
{
	...
	auto result = this->client_.Post("/sendFriendMessage", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                      ...
                                      std::optional<MessageId_t> QuoteId)
{
	...
	if (QuoteId.has_value()) body["quote"] = QuoteId.value();
	auto result = this->client_.Post("/sendGroupMessage", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                     ...
                                     std::optional<MessageId_t> QuoteId)
{
	...
	if (QuoteId.has_value()) body["quote"] = QuoteId.value();
	auto result = this->client_.Post("/sendTempMessage", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::SendNudge(const string& SessionKey, QQ_t target, UID_t subject, NudgeType kind)
{
	...
	auto result = this->client_.Post("/sendNudge", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::Recall(const string& SessionKey, MessageId_t id, UID_t target)
{
	...
	auto result = this->client_.Post("/recall", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::RoamingMessages(const string& SessionKey, std::time_t TimeStart, std::time_t TimeEnd, UID_t target)
{
	...
	auto result = this->client_.Post("/roamingMessages", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp["data"];
}
                              ...
                              int64_t offset, int64_t size, bool withDownloadInfo)
{
	...
	auto result = this->client_.Get("/file/list", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
                              ...
                              bool withDownloadInfo)
{
	...
	if (!path.empty()) params.emplace("path", path);
		...
		params.emplace("id", id);
	auto result = this->client_.Get("/file/info", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
                               ...
                               const string& directory)
{
	...
	if (!path.empty()) body["path"] = path;
		...
		body["id"] = id;
	auto result = this->client_.Post("/file/mkdir", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
json HttpClientImpl::FileDelete(const string& SessionKey, const string& id, const string& path, UID_t target)
{
	...
	if (!path.empty()) body["path"] = path;
		...
		body["id"] = id;
	auto result = this->client_.Post("/file/delete", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                              ...
                              const string& TargetDirId, const string& TargetDirPath)
{
	...
	auto result = this->client_.Post("/file/move", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                ...
                                const string& name)
{
	...
	if (!path.empty()) body["path"] = path;
		...
		body["id"] = id;
	auto result = this->client_.Post("/file/rename", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                ...
                                const string& name, string content)
{
	...
	this->client_.set_compress(true);
	auto result = this->client_.Post("/file/upload", items);
...
json HttpClientImpl::UploadImage(const string& SessionKey, const string& type, string image)
{
	...
	auto result = this->client_.Post("/uploadImage", items);
...
json HttpClientImpl::UploadAudio(const string& SessionKey, const string& type, string Audio)
{
	...
	auto result = this->client_.Post("/uploadVoice", items);
...
{
	json body = {{"sessionKey", SessionKey}, {"target", target}};
	auto result = this->client_.Post("/deleteFriend", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::Mute(const string& SessionKey, GID_t target, QQ_t member, std::chrono::seconds time)
{
	...
	auto result = this->client_.Post("/mute", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::Unmute(const string& SessionKey, GID_t target, QQ_t member)
{
	...
	auto result = this->client_.Post("/unmute", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::Kick(const string& SessionKey, GID_t target, QQ_t member, const string& message)
{
	...
	auto result = this->client_.Post("/kick", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	json body = {{"sessionKey", SessionKey}, {"target", target}};
	auto result = this->client_.Post("/quit", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	json body = {{"sessionKey", SessionKey}, {"target", target}};
	auto result = this->client_.Post("/muteAll", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	json body = {{"sessionKey", SessionKey}, {"target", target}};
	auto result = this->client_.Post("/unmuteAll", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	json body = {{"sessionKey", SessionKey}, {"messageId", id}, {"target", target}};
	auto result = this->client_.Post("/setEssence", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	httplib::Params params = {{"sessionKey", SessionKey}, {"target", target.to_string()}};
	auto result = this->client_.Get("/groupConfig", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                     ...
                                     std::optional<bool> AutoApprove, std::optional<bool> AllowAnonymousChat)
{
	...
	auto result = this->client_.Post("/groupConfig", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::GetMemberInfo(const string& SessionKey, GID_t target, QQ_t member)
{
	...
	auto result = this->client_.Get("/memberInfo", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                    ...
                                    const string& title)
{
	...
	auto result = this->client_.Post("/memberInfo", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::MemberAdmin(const string& SessionKey, GID_t target, QQ_t member, bool assign)
{
	...
	auto result = this->client_.Post("/memberAdmin", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::AnnoList(const string& SessionKey, GID_t target, int64_t offset, int64_t size)
{
	...
	if (offset > 0) params.emplace("offset", std::to_string(offset));
	if (size > 0) params.emplace("size", std::to_string(size));
	auto result = this->client_.Get("/anno/list", params, httplib::Headers{});
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
                                 ...
                                 bool ShowEditCard, bool ShowPopup, bool RequireConfirm)
{
	...
	auto result = this->client_.Post("/anno/publish", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp.at("data");
}
...
json HttpClientImpl::AnnoDelete(const string& SessionKey, GID_t target, const string& fid)
{
	...
	auto result = this->client_.Post("/anno/delete", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                               ...
                                               int operate, const string& message)
{
	...
	auto result = this->client_.Post("/resp/newFriendRequestEvent", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                                ...
                                                int operate, const string& message)
{
	json body = {{"sessionKey", SessionKey}, {"eventId", EventId}, {"fromId", FromId},
	             {"groupId", GroupId},       {"operate", operate}, {"message", message}};
	auto result = this->client_.Post("/resp/memberJoinRequestEvent", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                                         ...
                                                         GID_t GroupId, int operate, const string& message)
{
	json body = {{"sessionKey", SessionKey}, {"eventId", EventId}, {"fromId", FromId},
	             {"groupId", GroupId},       {"operate", operate}, {"message", message}};
	auto result = this->client_.Post("/resp/botInvitedJoinGroupRequestEvent", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
json HttpClientImpl::CmdExecute(const string& SessionKey, const json& command)
{
	...
	auto result = this->client_.Post("/cmd/execute", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
                                 ...
                                 const string& usage, const string& description)
{
	...
	auto result = this->client_.Post("/cmd/register", body.dump(), JSON_CONTENT_TYPE);
	json resp = Utils::ParseResponse(result);
	return resp;
}
...
{
	auto result = this->client_.Post(path, content, ContentType);
...
{
	auto result = this->client_.Get(path, params, httplib::Headers{});
